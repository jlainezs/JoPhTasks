...
/**
 * @package     JODK
 * @subpackage  Authentication.odkaggregate
 *
 * @copyright   Copyright (C) 2016 EConceptes
...
/**
 * ODKAggregate Authentication plugin
 *
 * @since  1.5
 */
class PlgAuthenticationOdkAggregate extends JPlugin
{
	/**
